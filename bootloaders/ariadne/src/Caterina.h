...
#define _CDC_H_
	...
	/* Function Prototypes: */
		...
		void caterinaInit(void);
		void caterinaResetTimeout(void);
		bool caterinaTimedOut(void);
...
/* USB status flag, it is set to TRUE if flashing from
 * usb is currently active */
uint8_t usbFlashing;
